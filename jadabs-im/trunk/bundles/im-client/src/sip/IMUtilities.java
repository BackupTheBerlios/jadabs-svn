...
public class IMUtilities {
    ...
    public static void writeFile(String outFile, String text) {
        try {
            ...
            else System.out.println("DebugIM, writeFile(),  unable to write, the file:"+
                    outFile +" is missing.");
        }
        catch (Exception e) {
            System.out.println("DebugIM, writeFile(),  unable to write, the file:"+
                    outFile +" is missing.");
            e.printStackTrace();
        }
    }
    ...
    public static boolean checkURI (String uri) {
    	return (uri != null && (uri.startsWith("sip:") || (uri.startsWith("sips:"))));
    }
