...
import gov.nist.sip.instantmessaging.presence.IMByeProcessing;
import gov.nist.sip.instantmessaging.presence.IMMessageProcessing;
...
public class ChatSession
{
    ...
    public void sendIMActionPerformed(ActionEvent evt)
    {
        try
        {
            ...
            //    "Unable to send Messages, close the
            ...
            if (remoteSipURL != null)
            {
                ...
                if (text == null || text.trim().equals(""))
                    new AlertInstantMessaging("You must type something!!!", JOptionPane.ERROR_MESSAGE);
                else
                {
                    textSent = text;
                ...
                new AlertInstantMessaging("You must set a remote url!!!", JOptionPane.ERROR_MESSAGE);
