...
public class AlertInstantMessaging extends JOptionPane
{
    ...
    public AlertInstantMessaging(String text, int messageType, String initialInputValue)
    {
        ...
        {
            finalInputValue = (String) showInputDialog(this, text, "Information", messageType, null, null,
                    initialInputValue);
        } else if (messageType == CONFIRMATION)
        {
            confirmationResult = JOptionPane.showConfirmDialog(this, text, "Confirmation", JOptionPane.YES_NO_OPTION);
        } else
            showMessageDialog(this, "Unknown alert message");
