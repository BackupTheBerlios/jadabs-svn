...
/**
 * The multipart subscriber is capable of handling a multipart notification
 * body, as needed if subscribing to a resourcelist.
 * 
 * <h3>To add</h3>
 * <ul>
...
public class SubscriberMultipart extends Subscriber
{
    ...
    /**
     * Simply takes the resource-list and adds attributes "fullState" and
     * "version" to the <resource-lists>-element and adds "cid"-attributes to
     * all <entity>-tags. It's probably not very correct conduct, but as of
     * writing it's not clear how these things are going to work.
     */
    ...
    public void updateNotifyBody(String newBody)
    {
        ...
        newBody = newBody.substring(0, start) + version + newBody.substring(end, newBody.length());
        ...
        //update notifyBody
        notifyBody = notifyBody.concat("Content-Transfer-Encoding: binary\n" + "Content-ID: " + cid + "\n"
