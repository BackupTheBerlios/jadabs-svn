...
public class RequestValidation
{
    ...
    public boolean validateRequest(SipProvider sipProvider, Request request, ServerTransaction st)
    {
        try
        {
            ...
            if (!checkURIScheme(request))
            {
                ...
                if (ProxyDebug.debug)
                    ProxyDebug
                            .println("RequestValidation: 416 UNSUPPORTED_URI_SCHEME replied:\n" + response.toString());
                return false;
            }
            ...
            if (!checkMaxForwards(request))
            {
                ...
                if (ProxyDebug.debug)
                    ProxyDebug.println("RequestValidation: 483 TOO_MANY_HOPS replied:\n" + response.toString());
                return false;
            }
            ...
            if (!checkLoopDetection(request))
            {
                ...
                if (ProxyDebug.debug)
                    ProxyDebug.println("RequestValidation: 482 LOOP_DETECTED replied:\n" + response.toString());
                return false;
            }
            ...
            if (!checkProxyRequire(request))
            {
                ...
                if (ProxyDebug.debug)
                    ProxyDebug.println("RequestValidation: 420 BAD_EXTENSION replied:\n" + response.toString());
                return false;
            }
            ...
            if (!checkProxyAuthorization(request))
            {
                ...
                if (response != null)
                {
                    ...
                    ProxyDebug.println("RequestValidation: 407 PROXY_AUTHENTICATION_REQUIRED replied:\n"
                            + response.toString());
                ...
                } else
                {
                    ...
                    if (ProxyDebug.debug)
                        ProxyDebug.println("RequestValidation: 500 SERVER_INTERNAL_ERROR replied:\n"
                                + response.toString());
                }
                return false;
            }
            ...
            if (!checkFromTag(request))
            {
                ...
                if (ProxyDebug.debug)
                    ProxyDebug.println("RequestValidation: 400 BAD_REQUEST replied:\n" + response.toString());
                return false;
            }
                ...
                if (method.equals("SUBSCRIBE"))
                {
                    ...
                    if (!presenceServer.hasAuthorization(request))
                    {
                        ...
                        if (serverTransaction != null)
                            ...
                            sipProvider.sendResponse(response);
                        if (ProxyDebug.debug)
                            ProxyDebug.println("RequestValidation: validateRequest()," + " 202 ACCEPTED replied:\n"
                                    + response.toString());
                        return false;
                    }
                }
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: validateRequest(), exception raised:");
    ...
    private boolean checkURIScheme(Request request)
    {
        try
        {
            ...
            return uriScheme.equals("sip") || uriScheme.equals("sips") || uriScheme.equals("tel");
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkURIScheme(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkMaxForwards(Request request)
    {
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkMaxForwards(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkLoopDetection(Request request)
    {
        try
        {
            ...
            while (viaList.hasNext())
            {
                ...
                {
                    //    ProxyDebug.println("RequestValidation,
                    // checkLoopDetection(),"+
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkLoopDetection(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkProxyRequire(Request request)
    {
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkProxyRequire(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkProxyAuthorization(Request request)
    {
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkProxyAuthorization(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkFromTag(Request request)
    {
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkFromTag(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
    ...
    private boolean checkEventHeader(Request request)
    {
        ...
        } catch (Exception e)
        {
            if (ProxyDebug.debug)
            {
                ProxyDebug.println("RequestValidation: checkEventHeader(), exception raised:");
                ProxyDebug.logException(e);
            }
            return false;
        }
