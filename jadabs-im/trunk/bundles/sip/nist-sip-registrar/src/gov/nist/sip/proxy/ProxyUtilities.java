...
public class ProxyUtilities
{
    ...
    public static void printTransaction(Transaction transaction)
    {
        if (transaction == null)
        {
            ProxyDebug.println("DEBUG TRANSACTION INFO: the transaction is null ");
            return;
        }
        ...
        if (transaction instanceof ServerTransaction)
        {
            ...
            ProxyDebug.println("DEBUG TRANSACTION INFO: here is the " + " server transaction: " + serverTransaction);

            ProxyDebug.println("DEBUG INFO: Its dialog is: " + serverTransaction.getDialog());
        } else if (transaction instanceof ClientTransaction)
        {
            ClientTransaction clientTransaction = (ClientTransaction) transaction;
            ProxyDebug.println("DEBUG TRANSACTION INFO: here is the " + " client transaction: " + clientTransaction);

            ProxyDebug.println("DEBUG TRANSACTION INFO: Its dialog is: " + clientTransaction.getDialog());
        }
    }
