...
/**
 * This subscriber supports the presence event package, cpid-pidf, partial
 * notify, notify filtering as described in the SIMPLE internet-drafts.
 */
...
public class SubscriberPresence extends Subscriber
{
    ...
    public SubscriberPresence(String fromURI, Dialog d, int exp, boolean part)
    {
        ...
        String fileName = new String(fromURI.substring(colon, at) + File.separator + "filter.xml");
