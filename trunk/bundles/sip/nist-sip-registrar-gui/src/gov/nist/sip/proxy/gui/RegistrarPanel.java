...
public class RegistrarPanel extends JPanel
{
    ...
    public void initComponents()
    {
         ...
         * If put to False: we see the container's background
         * secondPanel.setOpaque(false); //rows, columns, horizontalGap,
         * verticalGap secondPanel.setLayout( new GridLayout(1,1,0,0) );
         * 
        ...
        JScrollPane scrollPane = new JScrollPane(domainList, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    public void addLPButtonActionPerformed(ActionEvent evt)
    {
        ...
        if (dd.domainTextField.getText() == null || dd.domainTextField.getText().trim().equals(""))
            return;
