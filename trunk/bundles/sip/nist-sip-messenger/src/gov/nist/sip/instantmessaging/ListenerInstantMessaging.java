...
import gov.nist.sip.instantmessaging.presence.IMNotifyProcessing;
import gov.nist.sip.instantmessaging.presence.IMPublishProcessing;
import gov.nist.sip.instantmessaging.presence.IMRegisterProcessing;
import gov.nist.sip.instantmessaging.presence.IMSubscribeProcessing;
...
public class ListenerInstantMessaging
{
        ...
        if (e.getClickCount() == 2)
        {
            ...
            } else
            {
                ...
                if (imRegisterProcessing.isRegistered())
                {
                    ...
                    new AlertInstantMessaging("You must sign in first to the server!!!", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void tracesViewerActionPerformed(ActionEvent evt)
    {
        try
        {
             ...
             *  // Thread for Debug: errorViewerThread=new
    ...
    public void addContact(String contact)
    {
        try
        {
            ...
            // if (imRegisterProcessing.isRegistered()) {
            AlertInstantMessaging alert = new AlertInstantMessaging("Do you want to add " + contact
                    + " to your buddy list?", AlertInstantMessaging.CONFIRMATION, null);
    ...
    public void addContactActionPerformed(ActionEvent evt)
    {
        ...
        if (imRegisterProcessing.isRegistered())
        {
            AlertInstantMessaging alert = new AlertInstantMessaging("Enter the URI" + " of the buddy to add:",
            ...
            if (alert.finalInputValue != null)
            {
                ...
                {
                    new AlertInstantMessaging("The URI is not valid: enter sip:....", JOptionPane.ERROR_MESSAGE);
                } else
                {
    ...
    public void removeContactActionPerformed(ActionEvent evt)
    {
        ...
        if (imRegisterProcessing.isRegistered())
        {
            ...
            AlertInstantMessaging alertInstantMessaging = new AlertInstantMessaging(
                    "Are you sure to remove the selected contact?", AlertInstantMessaging.CONFIRMATION, null);
            ...
            if (confirmationResult == JOptionPane.YES_OPTION)
            {
                ...
                {
                    new AlertInstantMessaging("You must select a contact to remove!", JOptionPane.ERROR_MESSAGE);
                }
            }
        } else
            new AlertInstantMessaging("You must sign in first to the server!!!", JOptionPane.ERROR_MESSAGE);
    ...
    public String getLocalSipURL()
    {
        try
        {
            ...
            {
                new AlertInstantMessaging("You must enter your sip url before signing in!!!", JOptionPane.ERROR_MESSAGE);
                return null;
            } else
            {
