...
public class XMLAuthenticationParser extends DefaultHandler
{
    ...
    public void startDocument() throws SAXException
    {
        try
        {
            DebugIM.println("DebugIM, XMLAuthenticationParser, startDocument(): " + " Parsing XML passwords file");
        } catch (Exception e)
        {
    ...
    public void writeToXMLFile(Vector usersTagList)
    {
        ...
        {
            DebugIM.println("DebugIM, XMLAuthenticationParser, writeToXMLFile(), exception" + " raised:");
            e.printStackTrace();
        }
    }
