...
import gov.nist.sip.instantmessaging.presence.cpimparser.XMLcpimParser;
import gov.nist.sip.instantmessaging.presence.pidfparser.XMLpidfParser;
...
{
    private Logger LOG = Logger.getLogger(NotifyProcessing.class);
    ...
    public NotifyProcessing(SipGatewayImpl sipgw)
    {
        this.sipgw = sipgw;
    ...
    {
        LOG.debug("Processing OK received for a NOTIFY ");

    }

    public void processNotify(Request request, ServerTransaction serverTransaction)
    {
        LOG.debug("Process NOTIFY in progress...");
...
//            RegisterProcessing imRegisterProcessing = sipgw.getIMRegisterProcessing();
//            if (imRegisterProcessing.isRegistered())
//            {
//                //Fetching the sip-uri from gui. Isn't that a bit odd?
//                PublishProcessing imPublishProcessing = sipgw.getIMPublishProcessing();
//                javax.swing.JTextField guiSipURI = sipgw.getInstantMessagingGUI().getLocalSipURLTextField();
...
//    }
    ...
    public void sendNotify(Response okSent, String body, Dialog dialog)
    {
        try
        {
            ...
            {
                LOG.debug("DEBUG, IMNotifyProcessing, sendNotify(), request-uri is null");
                return;
            }
            ...
            LOG.debug("DEBUG, IMNotifyProcessing, sendNotify(), We add the Subscription-State"
            ...
            LOG.debug("DEBUG, IMNotifyProcessing, sendNotify()," + " NOTIFY sent:\n");
