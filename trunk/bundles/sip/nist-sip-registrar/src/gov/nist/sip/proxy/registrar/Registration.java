...
public class Registration
{
    ...
    protected ExportedBinding exportBinding()
    {
        ...
        if (this.contactsList != null)
            retval.contactAddress = ((ContactHeader) contactsList.elementAt(0)).getAddress().toString();
    ...
    public void removeContactHeader(ContactHeader contactParameter)
    {
        ...
        javax.sip.address.URI cleanUri = Registrar.getCleanUri(addressParam.getURI());
        ...
        for (int i = 0; i < contactsList.size(); i++)
        {
            ...
            if (contact.equals(contactParam))
            {
                ...
                ProxyDebug.println("DEBUG, Registration, removeContactHeader():" + " The contact: " + contact
                        + " has been removed for the key: " + key);
                break;
            }
        }
    ...
    public void updateContactHeader(ContactHeader contactParameter)
    {
        ...
        for (int i = 0; i < contactsList.size(); i++)
        {
            ...
            if (contact.equals(contactParam))
            {
                ...
                ProxyDebug.println("DEBUG, Registration, updateContactHeader():" + " The contact: " + contact
                        + " has been updated for the key: " + key);
                break;
            }
        }
    }
    ...
    public String getXMLTags()
    {
        ...
        for (int i = 0; i < contactsList.size(); i++)
        {
            ...
            if (contactHeader.getExpires() != -1)
            {
                ...
                retval.append(" expires=\"" + Registrar.EXPIRES_TIME_MAX + "\" ");
            retval.append(" />\n");
