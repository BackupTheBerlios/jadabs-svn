...
class Binding
{
    ...
    protected ExportedBinding exportBinding()
    {
        ...
        if (this.contactHeader != null)
            retval.contactAddress = this.contactHeader.getAddress().toString();
        return retval;

    }

    /** Creates new Binding */
    protected Binding(javax.sip.address.URI requestURI, ContactHeader contactHeader, long cseq, long expiresTime,
